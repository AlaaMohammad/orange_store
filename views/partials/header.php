...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="<?php echo isUrl('/') ? 'nav-link active' : 'nav-link'?>" aria-current="page" href="/">Home</a>
                </li>
                <li class="nav-item">
                    <a class="<?php echo isUrl('/products') ? 'nav-link active' : 'nav-link'?>" href="/products">Products</a>
                </li>
                <li class="nav-item">
                    <a class="<?php echo  isUrl('/pricing') ? 'nav-link active' : 'nav-link'?>" href="/pricing">Pricing</a>
                </li>
            </ul>
        </div>
    </div>
